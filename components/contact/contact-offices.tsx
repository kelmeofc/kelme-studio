...
function OfficeCard({ title, address, phone, phoneHref, whatsappHref }: OfficeCardProps) {
  ...
  return (
    <div className="bg-dark-card p-6 rounded-xl border border-emerald/20 transition-transform hover:scale-[1.02] duration-300">
      ...
      <div className="flex items-center space-x-2 text-sm mb-4">
        ...
        <a href={phoneHref} className="hover:text-emerald transition-colors">
          {phone}
        </a>
      </div>
      ...
      {whatsappHref && (
        <a 
          ...
          className="inline-flex items-center space-x-2 bg-emerald/20 hover:bg-emerald/30 text-emerald px-3 py-2 rounded-lg transition-colors text-sm"
        >
